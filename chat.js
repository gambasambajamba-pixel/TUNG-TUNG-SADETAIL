(() => {
  ...
  document.head.insertAdjacentHTML('beforeend', `<style>
    /* Final customer-facing presentation */
    .hero{isolation:isolate}.hero:after{content:'';position:absolute;inset:0;background:radial-gradient(circle at 77% 20%,rgba(82,158,255,.23),transparent 28%);pointer-events:none;z-index:-1}.hero-copy{padding-bottom:155px}.tt-hero-kicker{display:inline-flex;align-items:center;gap:9px;margin-bottom:18px;padding:8px 11px;border:1px solid rgba(177,215,255,.38);border-radius:999px;background:rgba(7,24,52,.34);color:#dcecff;font:800 10px Manrope;letter-spacing:.09em;text-transform:uppercase;backdrop-filter:blur(6px)}.tt-hero-kicker:before{content:'';width:7px;height:7px;border-radius:50%;background:#7cffb2;box-shadow:0 0 0 4px rgba(124,255,178,.12)}.hero-copy .eyebrow{display:none}.hero-actions{display:flex;gap:12px;align-items:center;flex-wrap:wrap}.hero-actions .btn{min-width:174px}.tt-hero-estimate{display:inline-flex;align-items:center;justify-content:center;min-width:164px;padding:14px 18px;border:1px solid rgba(255,255,255,.66);border-radius:999px;color:#fff;font:800 11px Manrope;letter-spacing:.04em;transition:background .2s ease,transform .2s ease}.tt-hero-estimate:hover{background:rgba(255,255,255,.12);transform:translateY(-2px)}.tt-hero-proof{position:absolute;right:max(28px,calc((100% - 1200px)/2 + 28px));bottom:30px;display:flex;gap:23px;color:#ecf6ff;font:800 10px Manrope;letter-spacing:.07em;text-transform:uppercase}.tt-hero-proof span{display:flex;align-items:center;gap:8px}.tt-hero-proof i{display:block;width:5px;height:5px;border-radius:50%;background:#8fc2ff}.tt-standard{background:#fff;padding:92px 0}.tt-standard-wrap{max-width:1200px;margin:auto;padding:0 28px;display:grid;grid-template-columns:.8fr 1.2fr;gap:54px;align-items:end}.tt-standard h2{margin:10px 0 0;font:700 clamp(35px,4.7vw,56px)/1 'Playfair Display',serif;letter-spacing:-.06em}.tt-standard p{margin:16px 0 0;max-width:360px;font-size:14px;line-height:1.7;color:#52677f}.tt-standard-cards{display:grid;grid-template-columns:repeat(3,1fr);gap:13px}.tt-standard-card{min-height:190px;padding:24px 20px;border:1px solid #dce6f0;border-radius:18px;background:linear-gradient(145deg,#fbfdff,#edf6ff);box-shadow:0 12px 28px rgba(12,38,77,.06)}.tt-standard-card b{display:grid;place-items:center;width:35px;height:35px;margin-bottom:37px;border-radius:11px;background:#0b2343;color:#fff;font:800 15px Manrope}.tt-standard-card h3{margin:0;font:700 19px/1.1 'Playfair Display',serif;letter-spacing:-.04em}.tt-standard-card p{margin:8px 0 0;font-size:12px;line-height:1.55;color:#58708b}.booking .form:before{content:'Appointment request';grid-column:span 2;font:800 10px DM Mono,monospace;letter-spacing:.13em;color:#527399;text-transform:uppercase;margin-bottom:-5px}.booking .form:after{content:'We will personally confirm your date, time, and exact service location.';grid-column:span 2;font-size:11px;line-height:1.5;color:#5e7189;margin-top:-2px}.quick-reviews strong{letter-spacing:-.03em}.review-card{position:relative;overflow:hidden}.review-card:after{content:'“';position:absolute;right:26px;bottom:-28px;color:rgba(20,119,255,.1);font:150px 'Playfair Display',serif;line-height:1}.maintenance-form,.form{position:relative}.maintenance-form{box-shadow:0 22px 46px rgba(12,52,105,.11)}@media(max-width:820px){.tt-standard-wrap{grid-template-columns:1fr;gap:30px}.tt-standard-cards{grid-template-columns:1fr 1fr}.hero-copy{padding-bottom:150px}.tt-hero-proof{right:auto;left:20px;bottom:31px;gap:13px;font-size:9px}.tt-hero-proof span:nth-child(3){display:none}}@media(max-width:560px){.hero-copy{padding-top:108px;padding-bottom:132px}.tt-hero-kicker{font-size:9px;letter-spacing:.06em}.hero-actions{display:grid;grid-template-columns:1fr}.hero-actions .btn,.tt-hero-estimate{width:100%;min-width:0}.tt-standard{padding:70px 0}.tt-standard-wrap{padding:0 20px}.tt-standard-cards{grid-template-columns:1fr}.tt-standard-card{min-height:auto}.tt-standard-card b{margin-bottom:23px}.tt-hero-proof{display:block;line-height:2}.tt-hero-proof span{display:flex}.booking .form:before,.booking .form:after{grid-column:span 1}}
  </style>`);
  document.head.insertAdjacentHTML('beforeend', `<style>
  ...
  if (heroCopy) {
    heroCopy.insertAdjacentHTML('afterbegin', '<div class="tt-hero-kicker">Now booking across the 626 area</div>');
    const heroButton = heroCopy.querySelector('.btn');
    if (heroButton) heroButton.outerHTML = '<div class="hero-actions"><a class="btn" href="#booking">Request an appointment ↗</a><a class="tt-hero-estimate" href="sms:+16265617482?body=Hi%20TungTungSADetail%2C%20I%20would%20like%20an%20estimate.">Text for an estimate</a></div>';
    heroCopy.insertAdjacentHTML('afterend', '<div class="tt-hero-proof"><span><i></i>Careful hand work</span><span><i></i>Real local service</span><span><i></i>Clear pricing</span></div>');
  }
  ...
  if (gallery) gallery.insertAdjacentHTML('beforebegin', '<section class="tt-standard"><div class="tt-standard-wrap"><div><div class="eyebrow">The TungTung standard</div><h2>Care that shows<br>in the details.</h2><p>Every appointment is built around your car, your location, and a result you will be proud to drive.</p></div><div class="tt-standard-cards"><article class="tt-standard-card"><b>✦</b><h3>Thoughtful work</h3><p>We take the time to clean the places that make the biggest difference.</p></article><article class="tt-standard-card"><b>⌖</b><h3>Made for your day</h3><p>Mobile service at your driveway or another agreed service location.</p></article><article class="tt-standard-card"><b>✓</b><h3>Easy to book</h3><p>Choose your preferred day, then Alex confirms the details with you.</p></article></div></div></section>');
