(() => {
  ...
  document.head.insertAdjacentHTML('beforeend', `<style>
    ...
    .tt-season-feature{padding:0;background:#fff}.tt-season-feature-inner{max-width:1200px;margin:0 auto;padding:50px 28px;display:grid;grid-template-columns:1fr 1.25fr;gap:35px;align-items:center}.tt-season-feature h2{font:700 clamp(31px,4vw,49px)/1 'Playfair Display',serif;letter-spacing:-.05em;margin:9px 0 13px}.tt-season-feature p{font-size:13px;line-height:1.7;max-width:460px;margin:0}.tt-season-points{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}.tt-season-point{min-height:137px;padding:18px;background:var(--season-soft);border:1px solid var(--season-line);border-radius:18px}.tt-season-point b{display:block;font-size:25px;margin-bottom:10px}.tt-season-point strong{font-size:12px;line-height:1.25;display:block}.tt-season-feature a{display:inline-flex;margin-top:20px;background:#071429;color:#fff;padding:12px 15px;font:800 10px Manrope;letter-spacing:.07em;text-transform:uppercase}
    body[data-season='spring']{--season-1:#147f70;--season-2:#63b84c;--season-soft:#e9f8e5;--season-line:#b7e2ad}body[data-season='summer']{--season-1:#12b5e8;--season-2:#2867eb;--season-soft:#e7faff;--season-line:#9bdff3}body[data-season='summer'] #tt-season{background:linear-gradient(180deg,#2b8ef8 0%,#2dbeea 63%,#f6d37c 64%,#f7c96f 100%)}body[data-season='summer'] #tt-season:after{content:'〰 〰 〰 〰 〰 〰';left:-20px;right:auto;bottom:-4px;top:auto;color:#fff;opacity:.86;font-size:26px;letter-spacing:10px}body[data-season='fall']{--season-1:#a94d19;--season-2:#e49b27;--season-soft:#fff3df;--season-line:#f1c87d}body[data-season='winter']{--season-1:#24538d;--season-2:#8355c7;--season-soft:#edf5ff;--season-line:#bdd7f3}
    @media(max-width:760px){.tt-season-wrap{padding:0 20px;display:block}.tt-season-copy{margin-bottom:9px;align-items:flex-start}.tt-season-copy span{display:block}.tt-season-wrap a{margin-left:31px}.tt-season-art{right:14px;bottom:-5px;font-size:25px;letter-spacing:2px}.tt-season-art .tt-sun{font-size:30px}.tt-steps-wrap{padding:0 20px;display:block}.tt-steps-list{margin-top:22px;grid-template-columns:1fr}.tt-step{padding:16px}.tt-season-copy strong{min-width:80px}.tt-season-feature-inner{padding:40px 20px;display:block}.tt-season-points{margin-top:23px;grid-template-columns:1fr}.tt-season-point{min-height:0}}
  </style>`);
  ...
  const seasonalCampaigns = [
    ...
    { season: 'summer', icon: '🏖️', title: 'Summer Shine Month', copy: 'Beach days, road trips, and a fresh clean ride.', cta: 'Get summer ready', art: '<span class="tt-sun">☀️</span><span>🌴</span><span>🏖️</span>' },
    { season: 'summer', icon: '🌊', title: 'Summer Clean-Up Month', copy: 'Sand, crumbs, and dust out. Fresh-car feeling in.', cta: 'Book a detail', art: '<span class="tt-sun">☀️</span><span>🌴</span><span>🌊</span>' },
    { season: 'summer', icon: '🍉', title: 'Heat & Dust Reset Month', copy: 'A cool, clean interior makes summer drives better.', cta: 'Refresh my car', art: '<span class="tt-sun">☀️</span><span>🌴</span><span>🍉</span>' },
  ...
  if (services) services.insertAdjacentHTML('afterend', `<section class="tt-season-feature"><div class="tt-season-feature-inner"><div><div class="eyebrow">${campaign.icon} ${campaign.title}</div><h2>${campaign.season === 'summer' ? 'Beach days are better with a fresh ride.' : 'A seasonal refresh for your ride.'}</h2><p>${campaign.season === 'summer' ? 'From sandy floors to road-trip crumbs and summer dust, book the detail that makes every drive feel better.' : campaign.copy}</p><a href="#booking">${campaign.cta} ↗</a></div><div class="tt-season-points"><article class="tt-season-point"><b>${campaign.season === 'summer' ? '🏖️' : '✨'}</b><strong>${campaign.season === 'summer' ? 'Beach-day cleanup' : 'Seasonal refresh'}</strong></article><article class="tt-season-point"><b>${campaign.season === 'summer' ? '🛣️' : '🚗'}</b><strong>${campaign.season === 'summer' ? 'Road-trip ready' : 'Ready for every drive'}</strong></article><article class="tt-season-point"><b>${campaign.season === 'summer' ? '🧊' : '🫧'}</b><strong>${campaign.season === 'summer' ? 'Cool, clean interior' : 'Clean inside and out'}</strong></article></div></div></section>`);
